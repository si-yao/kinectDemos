...
private:
    ...
    HRESULT CreateBitmap(DWORD width, DWORD height, HBITMAP* phBitmap, BITMAPINFO* pBmi, void* pBitmapBits, UINT nID);

    /// <summary>
    /// Updates the specified bitmap using the given mxArray
    /// </summary>
    /// <param name="pImg">pointer to mxArray with image data</param>
    ...
    void UpdateBitmap(mxArray* pImg, HBITMAP* phBitmap, BITMAPINFO* pBmi);
    ...
    // Helpers
    Microsoft::KinectBridge::MatlabFrameHelper m_frameHelper;
    MatlabHelper m_matlabHelper;
